...
//func oldvalidate(JSONObject: [String: AnyObject], schema:[String: AnyObject]) -> Bool{
//
//    print(JSONObject)
//    
//    //setup schema
//    let requiredkeys = schema["required"] as! [String]
//    let schemaProperties = schema["properties"] as! [String: AnyObject]
//    
//    
//    //validate required
...
//        
//        
//        if schemaProperties.keys.contains(propertyKey){
//        
//            let validator = schemaProperties[propertyKey] as! [String: AnyObject]
//            isValidConstrains = constraintsCompliance(propertyValue, schema: validator)
//            
...
let result = validate(jsonDocument! , withSchema:jsonSchema!)
